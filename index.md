...
During my PhD, I have worked with [Prof. Can Liu](https://sweb.cityu.edu.hk/canliu/index.html) from the City University of Hong Kong to study how GenAI can support designers through the creative process. I have also had close collaborations with [Daniele Grandi](https://www.danielegrandi.com/) from AutoDesk Research and [Prof. Chris McComb](https://engineering.cmu.edu/directory/bios/mccomb-christopher.html) from Carnegie Mellon University. Here, we aimed to understand how capable LLMs are in generating diverse design solutions and compared the diversity of the LLM generated solutions with human crowdsourced design solutions. 
